...
package org.eclipse.birt.report.data.oda.ldap.ui;
...
/**
 * LDAP ODA data set designer page
 */
public class CustomDataSetWizardPage extends DataSetWizardPage
{

    private static final String QUERY_TEXT_HELP = "&Query Text Template : \n\n<SELECT ATTRIBUTES> attribute1,attribute2,...,attributeN \n<FROM BASE DN> BaseDN \n<WHERE> Filter Condition \n\n &Query Text Example : \n\n<SELECT ATTRIBUTES> cn,sn \n<FROM BASE DN> dc=maxcrc,dc=com \n<WHERE> cn=*";

	private static final String SAMPLE_QUERY_TEXT = "<SELECT ATTRIBUTES> cn,sn \n<FROM BASE DN> dc=maxcrc,dc=com \n<WHERE> cn=*";
    ...
    private Control createPageControl( Composite parent )
    {
        ...
        infoLabel.setText( QUERY_TEXT_HELP );
	...
	private void initializeControl( )
	{
        ...
        {
         //   return; // nothing to initialize
        	m_queryTextField.setText( SAMPLE_QUERY_TEXT );
        }else
        {
	...
	private void savePage( DataSetDesign dataSetDesign )
	{
        ...
        try
        {
             ...
             */
            IDriver customDriver = new org.eclipse.birt.report.data.oda.ldap.impl.Driver();
